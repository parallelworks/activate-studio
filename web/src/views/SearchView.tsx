  ...
  return (
    <div className="search-view">
      <div className="search-hero card">
        ...
        <p className="muted">Full-text and semantic search over proposals, partnerships, strategy, reports, and conventions. DOCX, PDF, and PPTX content is included.</p>
        <div className="search-bar">
          <input
            value={q}
            onChange={e => setQ(e.target.value)}
            onKeyDown={e => e.key === 'Enter' && run()}
            placeholder="e.g. HEATX benchmark, NeoCloud SLA split, CMMC status"
            autoFocus
          />
